    ...
    <div className="min-h-screen lg:flex">
      ...
      <div className="flex-1 lg:ml-60 flex flex-col min-h-screen">
        ...
        <header className="hidden lg:flex items-center gap-3 h-[60px] px-8 border-b bg-background sticky top-0 z-40 flex-shrink-0">
          ...
          {/* Month chip */}
          <button className="inline-flex items-center gap-2 px-3 py-2 rounded-[10px] bg-card border border-border text-sm font-medium hover:bg-muted transition-colors">
